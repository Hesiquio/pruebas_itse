...
if (isset($_SESSION["session_root"])) {
    ...
    <div class="row">
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><span class="fa fa-user"></span> PERFIL</h2>

                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <form class="form-horizontal form-label-left input_mask" method="post" id="form_edit" name="form_edit">
                        <div id="msg_info" style="display:block;width:47%;margin:1%;float:center;position:fixed;z-index:10003 !important; "></div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                            ...
                            <input class="form-control has-feedback-left" id="usuario" name="usuario" maxlength="10" placeholder="Nombre de usuario" value="<?=$row["Usuario"]?>" type="text" onkeyup="javascript:this.value=this.value.toUpperCase();">
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        </div>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><span class="fa fa-key"></span> Contraseña</h2>

                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <form class="form-horizontal form-label-left input_mask" method="post" id="form_edit_pass" name="form_edit_pass">
                        <div id="msg_info" style="display:block;width:47%;margin:1%;float:center;position:fixed;z-index:10003 !important; "></div>
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                            <label>Nombre de usuario:</label>
                            <input type="hidden" name="us_id" value="<?=$row["ID"]?>">
                            <input class="form-control has-feedback-left" disabled="disabled" id="nombre" name="nombre" placeholder="Nombre" value="<?=$row["Usuario"]?>" type="text" onkeyup="javascript:this.value=this.value.toUpperCase();">
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        </div>

                        <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                            <label>Contraseña atual</label>

                            <div class="input-group">
                                <input type="password" name="pass_login" id="pass_login" class="form-control" placeholder="Ingrese Contraseña" maxlength="8"  autocomplete="off">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                            ...
                            <div class="input-group">
                                <input type="password" name="pass_reg" id="pass_reg" class="form-control" placeholder="Ingrese Contraseña" maxlength="8"  autocomplete="off">
                                <span class="input-group-btn docs-tooltip" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Mostrar / Ocultar Contraseña">
                            <button class="btn btn-success" type="button" id="changer"><span id="changerclass" class="fa fa-eye"></span></button>
                            </span>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#form_edit").validate({
                ...
                messages:{
                    nombre: ap+" Escribe tu nombre completo."+ci,
                    usuario: ap+" Escribe un nombre de usuario valido."+ci
                },
                debug: true,
                errorElement: "span",
                submitHandler: function(form){
                    ...
                    $.ajax({
                        type: "post",
                        url:"_include/php/actions/action_apps_root_crud.php?edit=perfil",
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div id="msg_info2" style="display:block;width:90%;margin:1%;float:center;position:fixed;z-index:10003 !important; "></div>
                                <form class="form-horizontal form-label-left input_mask" method="post" id="form_add" name="form_add">

                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                        <label>Nombre completo:</label>
                                        <input class="form-control has-feedback-left" id="nombre_new" name="nombre_new" placeholder="Nombre" value="" type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off">
                                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                        <label>Usuario (Alias):</label>
                                        <input class="form-control has-feedback-left" id="usuario_new" maxlength="10" name="usuario_new" placeholder="Nombre de usuario" type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off">
                                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                    </div>

                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                        <div class="input-group">
                                            <input type="password" name="pass_login" id="pass_login" class="form-control" placeholder="Contraseña" maxlength="8"  autocomplete="off">
                                            <span class="input-group-btn docs-tooltip" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Mostrar / Ocultar Contraseña">
                                  <button class="btn btn-success" type="button" id="change"><span id="changeclass" class="fa fa-eye"></span></button>
                                  </span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <select name="rol_new" id="rol_new" class="form-control">
...
<div class="modal fade" id="cv_reg" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="success_cv" style="display:block;width:90%;margin:1%;float:center;position:fixed;z-index:10003 !important; "></div>
                <strong>Escriba la nueva clave de registro sin espacios. </strong>
                <hr>
                <form method="post" name="edit_cv" id="edit_cv">
                    <div class="row">
                        <div class="col-md-12">
                            <input type="text" name="cv_registro_a" id="cv_registro_a" class="form-control" placeholder="Escriba nueva clave" onkeyup="javascript:this.value=this.value.toUpperCase();">
                        </div>
                    </div>
                    <br>
                    <hr>
