                      ...
                      <div class="x_panel">
                        ...
                        <div id="msg_info2" style="display:block;width:90%;margin:1%;position:fixed;z-index:10003 !important; "></div>
                            ...
                            <label>Nombre completo:</label>
                                <label for="nombre_new"></label><input class="form-control has-feedback-left" id="nombre_new" name="nombre_new" placeholder="Nombre" value="" type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off">
                            ...
                            <label>Usuario (Alias):</label>
                                <label for="usuario_new"></label><input class="form-control has-feedback-left" id="usuario_new" maxlength="10" name="usuario_new" placeholder="Nombre de usuario" type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off">
                              <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                            </div>
