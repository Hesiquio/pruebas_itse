  ...
  <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabla 3.0 <small>Alumnos que ya aplicaron esta prueba.</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
            ...
            <div class="modal-dialog" id="lg-modal">
              <div class="modal-content">
                <div class="modal-header modal-header-success">
                      ...
                      <h4 class="modal-title" id="myModalLabel"><span class="fa fa-graduation-cap"></span> <strong>Vocación del Alumno</strong> </h4>
                    </div>
    ...
    function show_table(){
      var tabla = $("#tabla_alumnos").DataTable({
        ...
        "iDisplayLength": 5,
              ...
              "ajax" : {
              "method" : "POST",
              "url" : "_include/php/actions/json_data_table.php?app=03",
              },
              "columns" : [
              {"data" : 'nombre'},
              { 
        ...
        },
        {
          "data" : 'porcentaje',
                "render" : function(valor){
                  ...
                  return '<div class="btn-group">'+btn_1+btn_3+'</div>'
                }
        }
        ],
      ...
      $(document).ready(function(){
                ...
                $("#delete-form").validate({
                  event: "focus",
                    ...
                    $.ajax({
                      type: "post",
                            url:"_include/php/actions/action_apps_root_crud.php?app3_delete=student",
